        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Age = table.Column<int>(type: "int", nullable: false, defaultValue: 20),
                    OnCreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2022, 1, 21, 11, 35, 20, 203, DateTimeKind.Local).AddTicks(568))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Experience = table.Column<int>(type: "int", maxLength: 10, nullable: false),
